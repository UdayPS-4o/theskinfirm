...
export const metadata: Metadata = {
  ...
  description: "The Skin Firm offers exceptional skincare services and advanced treatments to help you achieve radiant, healthy skin. Book your consultation today!",
