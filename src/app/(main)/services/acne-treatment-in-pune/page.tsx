          ...
          <div className="flex items-center justify-center xl:w-1/2 px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-20">
            ...
            >
              <div className="flex flex-col gap-2.5">
                ...
                >
                  Expert dermatologist-led solutions for pimples, acne scars &
                  breakouts.
                </h4>
              </div>
              <div
          ...
          <div className="flex flex-col gap-12 md:gap-[90px]">
            ...
            >
              {[
                ...
                {
                  title: "Personalised Acne Care Plan",
                  description:
                    "Your customised plan may include medicated facials, chemical peel for acne in Pune, laser therapy, LED light therapy, or a combination approach.",
                },
                {
                  title: "Advanced Procedure",
                  description:
                    "Sessions are comfortable, with minimal downtime. Treatments may include deep cleansing, gentle exfoliation, targeted active ingredients, and laser treatment for acne scars in Pune to accelerate healing and prevent recurrence.",
                },
                {
                  title: "Aftercare & Maintenance",
                  description:
                    "We equip you with dermatologist-approved skincare and lifestyle guidance to maintain clear skin long-term.",
                },
              ].map((step, index) => (
                <div
                  key={index}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <p className="text-base leading-[22px] text-black mb-6">
                  Reactions may vary from minimal, depending on the treatment
                  used. Some redness, dryness, or mild peeling may occur for 1–3
          ...
          <div className="mx-6 lg:mx-24">
            ...
            <Accordion type="single" collapsible className="mt-10">
              {[
                {
                  question:
                    "How soon will I see results from the acne treatment?",
                  answer:
                    "Most clients notice visible improvement within 2–4 sessions, depending on acne severity and skin type. For enduring results, maintaining a long-term regimen is essential.",
                },
                {
                  question:
                    "Is this treatment suitable for hormonal or adult acne?",
                  answer:
                    "Yes. Our protocol is effective across all acne types, including hormonal, cystic, and adult-onset acne. The treatment is customised after a thorough skin evaluation.",
                },
                {
                  question:
                    "Can acne-prone, sensitive skin tolerate these procedures?",
                  answer:
                    "Absolutely. We carefully select our ingredients and modalities, ensuring they're effective yet non-irritating. Sensitive skin types are treated with additional attention.",
                },
                {
                  question: "Will this help with acne scars, too?",
                  answer:
                    "While this treatment primarily focuses on active acne, we also provide additional procedures like microneedling or laser resurfacing specifically for acne scars, which can be integrated into your plan.",
                },
                {
                  question: "How often should I get the treatment done?",
                  answer:
