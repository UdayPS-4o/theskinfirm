...
import type { AcneTreatmentContent } from '../acne-treatment-in-pune/types';

const StretchMarksRemovalClientPage = () => {
        ...
        <div className="flex flex-col xl:flex-row min-h-[500px] xl:min-h-[600px]">
          ...
          >
            <Image
              ...
              fill
              alt={"Stretch Marks Removal Treatment"}
...
export default StretchMarksRemovalClientPage;
