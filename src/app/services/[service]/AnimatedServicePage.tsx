  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="px-4 md:px-8 lg:px-[100px] py-8 md:py-12 lg:py-20 bg-[color:var(--color-light-background)]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col xl:flex-row justify-between items-center gap-6 md:gap-8 xl:gap-12">
            {/* Left Content */}
            <div id="hero-left" data-animate className={`flex flex-col gap-6 md:gap-8 xl:gap-[50px] w-full xl:w-[511px] transform transition-all duration-1000 ease-out ${
              isVisible('hero-left') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              <div className="flex flex-col gap-2.5">
                <small className={`text-sm leading-[17px] uppercase text-[#b76e79] font-semibold transform transition-all duration-700 delay-200 ease-out ${
                  isVisible('hero-left') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
                }`}>
                  {serviceData.hero.serviceCategory}
                </small>
                <h1 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[50px] leading-tight xl:leading-[50px] tracking-[-0.01em] text-[color:var(--color-dark-text)] font-semibold transform transition-all duration-700 delay-300 ease-out ${
                  isVisible('hero-left') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
                }`}>
                  {serviceData.hero.title}
                </h1>
                <h4 className={`text-base sm:text-lg md:text-xl xl:text-[21px] leading-relaxed xl:leading-[25px] text-[color:var(--color-dark-text)]/80 transform transition-all duration-700 delay-400 ease-out ${
                  isVisible('hero-left') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
                }`}>
                  {serviceData.hero.description}
                </h4>
              </div>
              <div className={`flex flex-col sm:flex-row gap-3 md:gap-5 transform transition-all duration-700 delay-500 ease-out ${
                isVisible('hero-left') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              }`}>
                <Link href="/#contact">
            ...
            {/* Right Content */}
            <div id="hero-right" data-animate className={`flex flex-col items-center xl:items-end w-full xl:w-[523px] relative transform transition-all duration-1000 delay-300 ease-out ${
              isVisible('hero-right') ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
            }`}>
              <div className="relative">
                <div className={`shadow-lg rounded-full border-4 md:border-8 border-[color:var(--color-light-background)] w-full max-w-[400px] md:max-w-[450px] xl:max-w-[504px] h-[250px] sm:h-[280px] md:h-[320px] xl:h-[355px] mx-auto transform transition-all duration-700 delay-600 ease-out hover:scale-105 overflow-hidden ${
                ...
                <div className={`absolute -bottom-2 md:-bottom-4 right-2 md:right-4 xl:right-0 shadow-lg rounded-lg border border-[color:var(--color-light-border)] p-3 md:p-4 bg-white max-w-[150px] md:max-w-[178px] transform transition-all duration-700 delay-800 ease-out hover:scale-105 ${
                  isVisible('hero-right') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
                }`}>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-12">
            ...
            <div id="about-content" data-animate className={`flex flex-col gap-4 w-full lg:w-[500px] transform transition-all duration-1000 delay-200 ease-out ${
              ...
              <h4 className={`text-xl md:text-2xl uppercase text-[color:var(--color-primary-brown)] font-semibold transform transition-all duration-700 delay-300 ease-out ${
                isVisible('about-content') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              }`}>
                {serviceData.about.title}
              </h4>
              <p className={`text-sm leading-[22px] text-[color:var(--color-dark-text)] font-medium transform transition-all duration-700 delay-400 ease-out ${
                isVisible('about-content') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              }`}>
                {serviceData.about.description}
              </p>
              <div className={`rounded-[10px] px-5 py-4 bg-[color:var(--color-light-background)] transform transition-all duration-700 delay-500 ease-out hover:scale-105 hover:shadow-md ${
                isVisible('about-content') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              }`}>
      ...
      <section className="py-12 md:py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-12 md:gap-[90px]">
            <div id="process-header" data-animate className={`text-center max-w-[602px] mx-auto transform transition-all duration-1000 ease-out ${
              isVisible('process-header') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              <h4 className={`text-xl md:text-2xl text-[color:var(--color-primary-orange)] font-medium mb-3 transform transition-all duration-700 delay-200 ease-out ${
                isVisible('process-header') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              }`}>
                ---------- {serviceData.process.subtitle} ----------
              </h4>
              <h2 className={`text-3xl md:text-[40px] leading-tight md:leading-[48px] text-[color:var(--color-dark-text)] font-semibold transform transition-all duration-700 delay-300 ease-out ${
                isVisible('process-header') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              }`}>
      ...
      <section className="py-12 md:py-20 px-4 md:px-8 bg-[color:var(--color-light-background)]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-12 md:gap-20">
            <div id="benefits-header" data-animate className={`text-center max-w-[602px] mx-auto transform transition-all duration-1000 ease-out ${
              isVisible('benefits-header') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              <h4 className={`text-xl md:text-2xl text-[color:var(--color-primary-orange)] font-medium mb-3 transform transition-all duration-700 delay-200 ease-out ${
            ...
            <div id="benefits-grid" data-animate className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
              {serviceData.benefits.items.map((benefit, index) => (
                <div key={index} className={`rounded-[10px] border border-[color:var(--color-light-background)] p-4 md:p-5 bg-white flex flex-row items-start gap-3 md:gap-4 transform transition-all duration-700 ease-out hover:scale-105 hover:shadow-xl hover:-translate-y-2 ${
                  isVisible('benefits-grid') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                }`} style={{ transitionDelay: `${400 + index * 100}ms` }}>
      ...
      <section className="py-12 md:py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-12 md:gap-20">
            <div id="postcare-header" data-animate className={`text-center max-w-[602px] mx-auto transform transition-all duration-1000 ease-out ${
              isVisible('postcare-header') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              <h4 className={`text-xl md:text-2xl text-[color:var(--color-primary-orange)] font-medium mb-3 transform transition-all duration-700 delay-200 ease-out ${
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-[84px]">
              ...
              <div id="postcare-downtime" data-animate className={`flex flex-col gap-4 transform transition-all duration-1000 delay-400 ease-out ${
                isVisible('postcare-downtime') ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
              }`}>
                ...
                <div className="rounded-[10px] border border-[color:var(--color-light-background)] p-5 bg-[color:var(--color-light-background-alt)] flex flex-col gap-[30px] hover:shadow-lg transition-shadow duration-300">
                  {serviceData.postCare.downtime.items.map((item, index) => (
                    <div key={index} className={`flex gap-[14px] items-start transform transition-all duration-500 ease-out hover:scale-105 ${
                      isVisible('postcare-downtime') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
              ...
              <div id="postcare-info" data-animate className={`flex flex-col gap-[30px] transform transition-all duration-1000 delay-500 ease-out ${
                isVisible('postcare-info') ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
              }`}>
                <h5 className="text-xl text-[color:var(--color-dark-text)] font-semibold">
                ...
                <div className="flex flex-col gap-[30px]">
                  {serviceData.postCare.postCare.items.map((item, index) => (
                    <div key={index} className={`flex gap-[14px] items-start transform transition-all duration-500 ease-out hover:scale-105 ${
                      isVisible('postcare-info') ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'
      ...
      <section className="py-12 md:py-20 px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col gap-12 md:gap-20">
            <div id="faq-header" data-animate className={`text-center max-w-[602px] mx-auto transform transition-all duration-1000 ease-out ${
            ...
            <div id="faq-grid" data-animate className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
              {serviceData.faq.questions.map((faq, index) => (
                <div key={index} className={`shadow-lg rounded-[10px] border border-[color:var(--color-border-light)] p-6 bg-white transform transition-all duration-700 ease-out hover:scale-105 hover:shadow-xl hover:-translate-y-2 ${
                  isVisible('faq-grid') ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
