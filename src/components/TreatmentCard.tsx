...
const TreatmentCard: React.FC<TreatmentCardProps> = ({
  ...
  return (
    <div className="bg-white border border-[#E6E6E6] rounded-[10px] p-[12px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.05)] w-full hover:shadow-[0px_0px_15px_0px_rgba(0,0,0,0.1)] transition-shadow duration-300">
      <div className="flex gap-[16px] items-start">
        ...
        <div className="flex-1 flex flex-col justify-start">
          <h3 className="text-[#D4A380] text-[16px] font-semibold leading-[20px] tracking-[-0.1px] m-0 mb-[8px]">
            {title}
          </h3>
          <p className="text-[#333333] text-[13px] font-normal leading-[18px] tracking-[-0.05px] m-0 mb-[12px] line-clamp-4 overflow-hidden">
            {description}
          </p>
