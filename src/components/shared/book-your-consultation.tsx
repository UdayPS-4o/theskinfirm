    ...
    <div className="mt-12 w-full">
      <div className="max-w-7xl mx-auto">
        <div className="p-4 sm:p-7 grid grid-cols-1 lg:grid-cols-2 gap-y-12 sm:gap-y-20 lg:gap-x-20">
          <div>
            <h2 className="text-start text-2xl sm:text-3xl text-[#8A7B70]">
              <span className="border-b-4 border-b-[#D4A380] pb-1">Book y</span>
              our Consultation
            </h2>
            <p className="mt-6 sm:mt-10 text-sm sm:text-base/relaxed text-[#A89689] text-start">
              Your Glow. Our Firm. Take the first step towards healthier, more
              radiant skin. Schedule a consultation with our skincare experts
              today.
            </p>
            <div className="mt-6 sm:mt-10 flex flex-col items-start justify-start space-y-6 sm:space-y-8">
              <div className="flex flex-row items-start justify-start space-x-3 sm:space-x-5">
                ...
                <div className="text-start flex-1">
                  <h4 className="text-sm sm:text-base text-[#8A7B70] font-medium">
                    Working hours
                  </h4>
                  <p className="mt-1 text-xs sm:text-sm text-[#A89689]">
              ...
              <div className="flex flex-row items-start justify-start space-x-5">
                ...
                <div className="text-start">
                  ...
                  <p className="mt-1 text-xs sm:text-sm text-[#A89689]">
                    ...
                    opp. Tribeca Highstreet, Sainik Vihar, Jarande Nagar,
              ...
              <div className="flex flex-row items-start justify-start space-x-5">
                ...
                <div className="text-start">
                  ...
                  <Link
                    ...
                    className="mt-1 text-xs sm:text-sm text-[#A89689] hover:text-[#D4A380] transition-colors"
                  >
                    +91 8308669966
                  </Link>
                </div>
              ...
              <div className="flex flex-row items-start justify-start space-x-5">
                ...
                <div className="text-start">
                  ...
                  <p className="mt-1 text-xs sm:text-sm text-[#A89689] text-wrap">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mt-6 sm:mt-10 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-5">
                <div className="w-full">
                  <Label htmlFor="fullName" className="text-[#8A7B70] mb-3">
                    Full name
                  </Label>
                  <Input
                    id="fullName"
              ...
              <div className="mt-5">
                <Label htmlFor="email" className="text-[#8A7B70] mb-3">
                  Email Address
                </Label>
                <Input
                  id="email"
              ...
              <div className="mt-5">
                <Button
                  type="submit"
                  className="w-full bg-[#D4A380] hover:bg-[#D4A380]/90"
