      ...
      <MaxWidthWrapper>
          ...
          >
            ...
            <div className='hidden lg:flex lg:flex-col col-span-1 order-1 lg:order-2'>
              ...
              >
                <Image className='w-full max-w-[300px] lg:max-w-none lg:w-full h-full object-cover rounded-2xl' src={'/hero-graphic-2.png'} width={457} height={598} alt='Woman with radiant, healthy skin after professional skincare treatment' loading='lazy' />
              </motion.div>
            </div>
          </motion.div>
      </MaxWidthWrapper>
