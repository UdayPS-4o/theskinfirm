        ...
        <div className="mt-28 flex flex-col lg:flex-row items-center justify-center gap-4">
          <div className="flex flex-row items-center lg:items-start justify-center gap-x-6 max-w-sm">
            ...
            <div>
              ...
              <p className="text-start text-wrap text-lg">
                We&apos;re more than a clinic, we&apos;re a growing movement in
                skin health. With a clear vision to redefine dermatology in Pune
                and beyond, The Skin Firm is committed to raising the standards
                of care, one confident client at a time. Our growth is guided by
          ...
          <div className="flex flex-row items-center lg:items-start justify-center gap-x-6 max-w-sm">
            ...
            <div>
              ...
              <p className="text-start text-wrap text-lg">
                At the heart of The Skin Firm is a constant evolution. We invest
                in the latest technologies, research-backed treatments, and
                artistic techniques not to follow trends, but to deliver results
                that are effective, safe, and uniquely tailored to modern Indian
                skin.
              </p>
            </div>
          </div>
          <div className="flex flex-row items-center lg:items-start justify-center gap-x-6 max-w-sm">
            ...
            <div>
              ...
              <p className="text-start text-wrap text-lg">
                We take a 360° approach to your skin and hair, treating concerns
                from their root, with a holistic blend of dermatology,
                aesthetics, nutrition, and lifestyle support. Because true
                beauty isn&apos;t just skin deep, and neither is our care.
              </p>
            </div>
          </div>
        </div>
