  ...
  const pigmentationTreatments = [
    {
      ...
      description: "Dark spots, melasma, and uneven skin tone can be especially taxing skin concerns. Often appearing as brown or greyish patches, or discoloration pigmentation can show up in different areas of the face and body, affecting confidence. At The Skin Firm, our advanced Pigmentation Treatment is designed to target these concerns."
    },
    {
      imageSrc: "https://picsum.photos/id/103/200/200",
      imageBgSrc: "https://picsum.photos/id/104/200/200",
      title: "Melasma Treatment",
      description: "Melasma is a common skin condition that causes brown or greyish patches, especially during skin concerns. Often appearing as brown or greyish patches, or discoloration pigmentation can show up in different areas of the face and body, affecting confidence. Triggered by hormones, sun exposure, or genetics."
    }
  ];
  ...
  const skinDiscolorationTreatments = [
    {
      ...
      description: "At The Skin Firm, we believe skin confidence isn't about changing who you are, but about feeling comfortable in your own skin. Our Skin Whitening Treatment in Pune is designed not to dramatically alter your natural skin tone, but to address uneven pigmentation and give you a more radiant, even complexion."
    },
    {
      imageSrc: "https://picsum.photos/id/107/200/200",
      imageBgSrc: "https://picsum.photos/id/108/200/200",
      title: "Tan Removal",
      description: "Sun exposure can take a visible toll on your skin, leaving behind stubborn tanning, dark patches, and even premature aging. At The Skin Firm, our Tan Removal Treatment in Pune is designed not to dramatically alter your natural skin tone, but to address uneven pigmentation and give you a more radiant, even complexion."
    },
    {
      imageSrc: "https://picsum.photos/id/109/200/200",
      imageBgSrc: "https://picsum.photos/id/110/200/200",
      title: "Underarm Whitening",
      description: "Dark underarms can make people feel self-conscious, especially when wearing sleeveless outfits, swimwear, or traditional wear. At The Skin Firm, we offer a specialized underarm whitening treatment designed to address this common concern with care and expertise."
    }
  ];
  ...
  const agingTreatments = [
    {
      ...
      description: "Ageing is a privilege, but visible signs of ageing don't have to be. As we age, our skin naturally loses its elasticity, firmness, and youthful glow, but they can be enhanced and delayed with the right interventions. At The Skin Firm, our Anti-Ageing Treatment in Pune is designed to help you age gracefully."
    },
    {
      imageSrc: "https://picsum.photos/id/113/200/200",
      imageBgSrc: "https://picsum.photos/id/114/200/200",
      title: "Wrinkle Treatment",
      description: "Wrinkles are one of the most visible signs of skin ageing, but they don't have to be permanent. Whether they appear as fine lines around the eyes, deeper lines around the mouth, or creases across the forehead, wrinkles can make us feel less confident about our appearance."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            <div className="h-px bg-[#EC7754] flex-1 max-w-20"></div>
            <h3 className="text-[#EC7754] text-lg font-medium">Our Services</h3>
            <div className="h-px bg-[#EC7754] flex-1 max-w-20"></div>
          </div>
